...
$incomedate=$year.$month.$day.$hour.$minute.'00'; //Action start date
...
if ($personid  == "" && $caseid == "")
  {
  echo "<p><a href='insertincome.php' style='text-decoration: none;'>Please enter Person or Matter ...</a></p>";
  exit;
  }

if ($cost == "")
  {
  echo "<p><a href='insertincome.php' style='text-decoration: none;'>Please enter a value cost ...</a></p>";
  exit;
  }

if($caseid == "")
{
$sql=mysql_query("INSERT INTO case2action (descr, statusid, userid, personid, procedureid, actiontypeid, actionstartdate, notes, cost, entryid) VALUES ('$descr', $statusid, $userid, $personid,1, 3, '$incomedate', '$notes', $cost, '$entryid')") or die("INSERT case2action Error: ".mysql_error());
}
else
if($caseid != "")
{
$sql=mysql_query("INSERT INTO case2action (descr, statusid, userid, caseid, procedureid, actiontypeid, actionstartdate, notes, cost, entryid) VALUES ('$descr', $statusid, $userid, $caseid,1, 3, '$incomedate', '$notes', $cost, '$entryid')") or die("INSERT case2action Error: ".mysql_error());
}
