...
$access=mysql_result($permission, 37);
if($access != "1")
{
...
$query=("SELECT max(aacode) as aacode FROM case2action WHERE actiontypeid=6 and isdeleted=0 and pinout=0")
...
<td><input type="hidden" name="descr" value="Incoming Protocol" /></td>
<td><input type="hidden" name="pinout" value="0" /></td>
</tr>
</table>
<table>
<tr>
...
<option value="0">Send Type</option>
<?php
...
<option value="0">Select Matter</option>
<?php
// printing the list box select command
