...
$sql1="SELECT descr FROM status WHERE id = $stid";
...
mysql_close();
?>
<FORM ACTION="updatemod2.php" METHOD="POST" NAME="updatestatus_form" id="commentForm">
<table>
<tr>
<td>
<input type="text" name="stdescr" value="<?php echo $row[descr]; ?>" class="required" size="60">
</td>
