...
$sql1="SELECT descr FROM doctype WHERE id = $doctypeid";
...
mysql_close();
?>
<FORM ACTION="updatemod2.php" METHOD="POST" NAME="updatedoctype_form" id="commentForm">
<table>
<tr>
<td>
<input type="text" name="doctypedescr" value="<?php echo $row[descr]; ?>" class="required" size="60">
</td>
<input type=hidden name=doctypeid value="<?php echo $doctypeid; ?>">
</tr>
</table>
<TABLE>
<TR>
