...
?>
<html>
<head><title>Default Matter Update</title>
...
$sql1="SELECT descr FROM thesaurus WHERE id = $dmid";
...
<tr>
<td>
<input type="text" name="dmdescr" value="<?php echo $row[descr]; ?>" class="required" size="60">
</td>
<input type=hidden name=dmid value="<?php echo $dmid; ?>">
</tr>
</table>
<TABLE>
<TR>
