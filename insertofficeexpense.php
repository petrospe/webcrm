...
$access=mysql_result($permission, 23);
if($access != "1")
{
...
$sql="SELECT id as id, descr as xpdescr FROM officeexptype ORDER BY xpdescr";
...
?>
<form action="officeexpenseindb.php" method="post" name="insertofficeexpense_form" id="commentForm">
<table>
<tr>
<td><select name="officeexptype">
<option value="">Select Default Office Expense</option>
<?php
// printing the list box select command
while($nt=mysql_fetch_array($final)){
echo "<option value='$nt[id]'>$nt[xpdescr]</option>";}
...
<table>
<tr>
<td><h4>Custon Description</h4></td>
<td><h4>Notes</h4></td>
</tr>
<tr>
<td><textarea rows="4" cols="60" name="descr">Office Expense</textarea></td>
<td><textarea rows="4" cols="58" name="notes"></textarea></td>
</tr>
</table>
  <br/>
<font size="4">Expense amount :
  <input onkeypress="return isNumberKey(event)" type="text" style="text-align: right; color:C11B17 " name="cost" class="required" /> Euro &#8364;</font>
  <br/>
  <br/>
<table>
<tr>
