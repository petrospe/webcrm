...
$access=mysql_result($permission, 20);
if($access != "1")
{
...
self.location="billing.php?personid=" + val ;
}
</script>
<script type="text/javascript">
$(function(){
...
<tr>
<td>
<form action="insertincome.php" method="post" name="newincome_form">
<input type="submit" value="New Income" id="button-3" />
</form>
</td>
<td>
<form action="insertexpense.php" method="post" name="newexpense_form">
<input type="submit" value="New Expense" id="button-4" />
</form>
</td>
<td>
<form action="insertofficeexpense.php" method="post" name="newofficeexpense_form">
<input type="submit" value="New Office Expense" id="button-5" />
</form>
</td>
</tr>
</table>
<em>Choose an undebited task to debit it, or a debited task to make changes about its debit. Also you have the option to change incomes and expenses.</em>
<h3>Task Search Criteria</h3>
<form name="form" action="billingsearch.php" method="get">
<table>
<tr>
<td><em>Billing Search</em></td>
<td>Order by</td>
</tr>
<tr>
<td><input type="text" name="billname" /></td>
<td>
<select name="orderby">
...
<tr>
<td>
<select style="width: 390px;" name="caseid">
...
<tr>
<td>
<select style="width: 390px;" name="action">
...
<td>
Tasks:
  <input type="checkbox" name="rtasks" value="1" checked="checked" />
  <br />
Expenses:
  <input type="checkbox" name="rexpenses" value="2" checked="checked" />
  <br />
Incomes:
  <input type="checkbox" name="rincomes" value="3" checked="checked" />
  <br />
Office Expenses:
  <input type="checkbox" name="roffice" value="4" checked="checked" />
  <br />
All:
  <input type="radio" name="r" value="" checked="checked" />
  <br />
Undebited:
  <input type="radio" name="r" value="and ca.cost = 0" />
  <br />
Debited:
  <input type="radio" name="r" value="and ca.cost &gt; 0" />
  <br />
...
<tr>
<td>Show Task Type:
  <input type="checkbox" name="ttype" value="1" checked="checked" />|
</td>
<td>Show Associated person:
  <input type="checkbox" name="assperson" value="1" checked="checked" />|
</td>
<td>Show Matter:
  <input type="checkbox" name="matter" value="1" checked="checked" />
</td>
</tr>
</table>
<table>
<tr>
<td>Show Date:
  <input type="checkbox" name="sdate" value="1" checked="checked" />|
</td>
<td>Show Time:
  <input type="checkbox" name="stime" value="1" checked="checked" />|
</td>
<td>Show Duration:
  <input type="checkbox" name="sduration" value="1" checked="checked" />|
</td>
<td>Show Status:
  <input type="checkbox" name="sstatus" value="1" checked="checked" />|
</td>
<td>Show user:
  <input type="checkbox" name="suser" value="1" checked="checked" />|
</td>
<td>Show Notes:
  <input type="checkbox" name="snotes" value="1" checked="checked" />
</td>
</tr>
</table>
  <br />
<table>
<tr>
  <th><input type="submit" name="Submit" value="Search" id="button-6" /></th>
</tr>
</table>
</form>
    </div>
