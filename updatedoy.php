...
$sql1="SELECT descr FROM doy WHERE id = $doyid";
...
mysql_close();
?>
<FORM ACTION="updatemod2.php" METHOD="POST" NAME="updatedoy_form" id="commentForm">
<table>
<tr>
<td>
<input type="text" name="doydescr" value="<?php echo $row[descr]; ?>" class="required" size="60">
</td>
<input type=hidden name=doyid value="<?php echo $doytid; ?>">
</tr>
</table>
<TABLE>
<TR>
