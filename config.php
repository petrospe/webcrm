...
connecttodb(getEnvVariable('DBSERVERNAME'),getEnvVariable('DBNAME'),getEnvVariable('DBUSERNAME'),getEnvVariable('DBPASSWORD'),getEnvVariable('DBPORT'));
...
function mysql_query($sql){
    $link = mysqli_connect(getEnvVariable('DBSERVERNAME'), getEnvVariable('DBUSERNAME'), getEnvVariable('DBPASSWORD'), getEnvVariable('DBNAME'), getEnvVariable('DBPORT'));
