...
$access=mysql_result($permission, 22);
if($access != "1")
{
...
self.location="insertexpense.php?personid=" + val ;
}
</script>
<script type="text/javascript">
$(function(){
...
?>
<form action="expenseindb.php" method="post" name="insertexpense_form"  id="commentForm">
<table>
<tr>
...
<tr>
<td><textarea rows="4" cols="60" name="descr">Expense</textarea></td>
