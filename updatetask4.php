...
<td><a href="javascript: void(0)" onclick="popup('updatemattertask.php?tid=<?php echo $row['Code']; ?>')"><?php echo $row['Matter']; ?></a></td>
      ...
      <form action="updatetask5.php" method="post" name="updatetask_form">
<table>
<tr>
...
if ($row['Cost'] == "0")
{
echo "<font color='ff0000'>Unbilled task</font>";
}
if ($row['Cost'] != "0")
{
echo "<font color='ff0000'>Billed task</font>";
}
?>
  </td>
</tr>
...
<tr>
  ...
  <th><input type="button" value="Back" onclick="document.location = 'myaccount.php';" id="button-6" /></th>
</tr>
</table>
</form>
    </div>
